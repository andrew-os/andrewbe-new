        ...
        <div className='min-h-screen flex flex-col'>
          ...
          <main className='my-10 grid grid-cols-12'>
            <div className='col-start-1 col-end-8'>
                    ...
                    <TextBody>I have worked and developed themes with the following Content Management Systems: Wordpress, SquareSpace, Shopify, Strapi, Contentful, Netlify.</TextBody>
