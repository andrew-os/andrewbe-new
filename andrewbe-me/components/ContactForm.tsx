    ...
    <form name="contact" method="POST" data-netlify="true" action="/success" netlify-honeypot="bot-field">
      ...
      <p className="flex flex-col">
        <label htmlFor="youremail" className="font-semibold" >
          email <span className="text-brand-pink text-xxs relative -mt-1">*</span>
        </label>
        <input type="email" required aria-required name="email" id="youremail" className="bg-brand-grey rounded-main my-4 h-10 pl-4 focus:outline-none focus:border-secondary focus:ring-2 focus:ring-secondary" />
      </p>
      <p className="flex flex-col">
        <label htmlFor="yourmessage" className="font-semibold">
          how can I help? <span className="text-brand-pink text-xxs relative -mt-1">*</span>
        </label>
        <textarea name="message" required aria-required id="yourmessage" className="h-32 my-10 bg-brand-grey my-4 rounded-main pl-4 pt-1 focus:outline-none focus:border-secondary focus:ring-2 focus:ring-secondary"></textarea>
      </p>
